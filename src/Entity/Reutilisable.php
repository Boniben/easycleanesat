...
#[ORM\Entity(repositoryClass: ReutilisableRepository::class)]
class Reutilisable
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Actions::class, mappedBy: 'reutilisable')]
    ...
    public function removeAction(Actions $action): static
    {
        if ($this->actions->removeElement($action)) {
            ...
            if ($action->getReutilisable() === $this) {
                $action->setReutilisable(null);
            }
        }
